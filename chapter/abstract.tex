...
\begin{abstract}[en]
 ...
 \keywords[Keywords:]{Deep Learning; Neural Networks; Image Recognition; Convolutional Neural Networks; Hybrid Models; Transfer Learning; Attention Mechanisms; Computer Vision}   
\end{abstract}
